...
struct global_data_all_processes : public parameters
{
  ...
  double OmegaNuPart; /**< neutrino particle density in units of the critical density (at z=0) */
  double OmegaNuLin;  /**< neutrino linear response density in units of the critical density (at z=0) */
  ...
  double MassHDM; /**< Mass of the HDM component */
  int NLR;
...
*/
  ...
  char ynuFile[MAXLEN_PATH];
#ifdef CB_PHASE
  char deltagridFILE[MAXLEN_PATH];
