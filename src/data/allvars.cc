...
void global_data_all_processes::register_parameters(void)
{
  ...
  add_param("OmegaNuPart", &OmegaNuPart, PARAM_DOUBLE, PARAM_FIXED);
  add_param("OmegaNuLin", &OmegaNuLin, PARAM_DOUBLE, PARAM_FIXED);
  ...
  add_param("MassHDM", &MassHDM, PARAM_DOUBLE, PARAM_FIXED);
  ...
  add_param("PrimordialIndex", &PrimordialIndex, PARAM_DOUBLE, PARAM_FIXED);  /* no longer used, the power spectrum input includes the spectral tilt already. */
